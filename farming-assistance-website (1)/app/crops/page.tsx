      ...
      <div className="flex-1 px-4 py-12">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {recommendation && (
              <div className="bg-green-50 rounded-lg shadow-md p-8 border border-border">
                ...
                <div className="mb-6">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {recommendation.recommendedCrops.map((crop: string) => (
                      <div
                        key={crop}
                        className="bg-white px-3 py-2 rounded-lg border border-primary/30 text-sm font-medium text-primary"
                      >
                        {crop}
                      </div>
                    ))}
                ...
                <div className="space-y-4 mb-6">
                  <div className="bg-white p-4 rounded-lg border border-border">
                    <p className="text-sm">
                      <strong>Soil Fertility:</strong> <span className="text-success">{recommendation.fertility}</span>
                    </p>
                  </div>
                  <div className="bg-white p-4 rounded-lg border border-border">
                    <p className="text-sm">
                      <strong>Rainfall Suitable:</strong>{" "}
                      <span className={recommendation.rainfallSuitable ? "text-success" : "text-danger"}>
                  ...
                  <div className="bg-white p-4 rounded-lg border border-border">
                    <p className="text-sm">
                      ...
                      <span className={recommendation.temperatureSuitable ? "text-success" : "text-danger"}>
